...
An example from the official docs: you might have a Container that acts as a web server for files in a shared Volume, and a separate file puller Container that updates those files from a remote content manager, as in the following diagram:
